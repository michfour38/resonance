      ...
      <div className="mx-auto flex h-12 max-w-5xl items-center justify-between">
        ...
        <div className="ml-auto flex h-12 items-center justify-end gap-3">
          <div className="relative flex h-12 items-center" onMouseLeave={() => setOpenMenu(null)}>
            ...
            {openMenu === "archive" ? (
              <div className="absolute right-0 top-12 z-30 min-w-[220px] rounded-[1.75rem] border border-zinc-800/80 bg-zinc-950/95 p-4 shadow-[0_10px_40px_rgba(0,0,0,0.45)]">
          ...
          <div className="relative flex h-12 items-center" onMouseLeave={() => setOpenMenu(null)}>
            ...
            {openMenu === "profile" ? (
              <div className="absolute right-0 top-12 z-30 min-w-[240px] rounded-[1.75rem] border border-zinc-800/80 bg-zinc-950/95 p-4 shadow-[0_10px_40px_rgba(0,0,0,0.45)]">
                ...
                <div className="mt-2 border-t border-zinc-800 pt-2">
                  <SignOutButton>
                    <button type="button" className="block w-full rounded-xl px-4 py-3 text-center text-sm text-zinc-300 transition hover:bg-zinc-900 hover:text-white">
                      Sign out
                    </button>
                  </SignOutButton>
                </div>
