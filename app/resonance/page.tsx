...
export default async function ResonancePage() {
  ...
  const typedProfile = profile as ResonanceProfile | null;
    ...
    <div className="max-w-2xl">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-stone-500">
          Your Resonance experience is being prepared.
        </p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="rounded-xl border border-stone-200 bg-white px-5 py-4">
          ...
          <p className="mt-0.5 text-xs text-stone-500">
            {cohort
              ? "Your 10-week Resonance experience begins automatically when your cohort starts."
              : "Your Resonance experience will begin once you've been placed in a cohort."}
          </p>
        </div>
      </div>
    </div>
