...
import {
  ...
  removePostAction,
} from "@/domains/moderation/moderation.actions";
...
export default async function ModerationPostDetailPage({ params }: Props) {
  ...
  const post = await getModerationPostDetail(params.postId);
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      <div>
        <a href="/moderation" className="text-xs text-muted-foreground underline">
          ← Back to queue
        </a>
