...
export default function HarmonizeSystemPage({
    ...
    >
      <section className="mx-auto max-w-5xl px-6 py-20">
        ...
        <p className="mt-6 max-w-3xl text-base leading-7 text-[#d8d2c6]">
          ...
          Conversations are separate threads inside this container. Shared space
          only becomes meaningful when participants choose to bring something
          forward.
        </p>

        {loading ? (
          <p className="mt-8 text-sm text-[#bfb8aa]">Loading container...</p>
        ) : null}
          ...
          <>
            <div className="mt-8 grid gap-4 md:grid-cols-3">
              ...
              <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6">
                ...
                <p className="mt-2 text-sm text-[#d8d2c6]">
                  Separate threads held inside this relationship space.
                </p>
              </div>
  ...
  Everyone listed below belongs to this container.
  Container ownership is administrative only and gives no
  additional authority inside the conversation.
  Every participant's private witness remains private unless
  they intentionally choose to share it.
</p>
                </div>
              ...
              <div className="mt-5 space-y-3">
                {system.participants?.map((participant: any, index: number) => {
        ...
        <p className="mt-2 text-xs text-[#c6a96b]">
          {participant.relationshipContext}
            ...
            <div className="mt-8 rounded-3xl border border-white/10 bg-white/[0.04] p-6">
              ...
              <p className="mt-3 text-sm leading-6 text-[#bfb8aa]">
                Name this conversation privately. Other participants can have
                their own name for the same thread.
              </p>
              ...
              >
                {starting ? "Beginning..." : "+ Begin a New Conversation"}
              </button>
            </div>
...
{cycle.hasPrivateWitness ? (
  ...
  <>
    <p className="mt-2 text-xs text-[#777]">
      {cycle.otherParticipants === 1
        ? "Another participant has entered this conversation."
        : `${cycle.otherParticipants} participants have entered this conversation.`}
    </p>
