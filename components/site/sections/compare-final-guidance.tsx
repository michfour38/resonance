    ...
    <section>
      <div className="mx-auto max-w-5xl px-5 py-24 text-center">
        ...
        <h2 className="text-3xl font-light leading-tight text-zinc-100 md:text-5xl">
          Awareness first. Then execution and alignment.
        </h2>
        ...
        <p className="mx-auto mt-8 max-w-3xl text-base leading-8 text-zinc-400">
          ...
          progression rather than isolated experiences. Resonance is strongly
          recommended as the foundational starting point before progressing
          into Compass.
        </p>
