...
// Server Component — verifies is_admin from database on every request.
      ...
      <header className="bg-[#2D4A3E] text-white">
        <div className="max-w-6xl mx-auto px-4 h-12 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-4 text-sm text-stone-300">
            <a href="/admin"         className="hover:text-white">Home</a>
            <a href="/admin/cohorts" className="hover:text-white">Cohorts</a>
            <a href="/admin/users"   className="hover:text-white">Users</a>
            <a href="/admin/circles" className="hover:text-white">Circles</a>
            <a href="/admin/reports" className="hover:text-white">Reports</a>
          </nav>
        </div>
      </header>
